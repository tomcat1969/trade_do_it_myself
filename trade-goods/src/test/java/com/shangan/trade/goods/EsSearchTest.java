...
//        goods.setStatus(1);
        ...
        Goods goods = new Goods();
        goods.setTitle("samsung Galaxy S21");
        goods.setBrand("samsung");
        goods.setCategory("cell phone");
        goods.setNumber("NO100003");
        goods.setImage("test");
        goods.setDescription("US Version, 128GB, Black - Unlocked");
        goods.setKeywords("5G Cell Phone, Factory Unlocked Android " +
                "Smartphone, 128GB, 120Hz Display Screen, Pro Grade Camera, " +
                "All Day Intelligent Battery, US Version, White");
        goods.setSaleNum(22);
        goods.setAvailableStock(55);
        goods.setPrice(366);
        goods.setStatus(1);
        goods.setId(24L);
    ...
    public void goodsSearch(){
        List<Goods> goodsList = searchService.searchGoodsList("apple", 0, 10);
        System.out.println(JSON.toJSONString(goodsList));
    }
}